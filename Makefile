# claudelint - Framework and tooling for linting, auditing, and formatting Claude plugins, skills, subagents, and more.

## Project Variables

PROJECT_NAME  := claudelint
PROJECT_OWNER := donaldgifford
DESCRIPTION   := Framework and tooling for linting, auditing, and formatting Claude plugins, skills, subagents, and more.
